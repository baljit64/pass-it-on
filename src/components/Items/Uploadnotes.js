...
class Uploadnotes extends Component {
  constructor() {
    ...
    this.state = {
      ...
      subcat: id.notesSubcat,
      cat_id: id.cat.notesid,
      sub_cat_id: null,
      topic: null,
      author: null,
      No_of_Pages: null,
  ...
  submitHandler = e => {
    ...
    if (this.valid()) {
      ...
      formData.append("no_of_pages", this.state.No_of_Pages)
      ...
      axios.post('details', formData).then(res => {
        if (res.data.message === "Your Item is stored on Notes section...") {
          this.setState({
            images: [],
            success: true,
            uploading: false
          ...
          <div className="col-lg-10 mx-auto">
            <div className="add-item-wrap">
              <form onSubmit={this.submitHandler}>
                <h1 className="item-name">Add Notes Detail</h1>
                {error}
                <div className="row ">
                ...
                <div className="row">
                  <div className="col-sm-12">
                    <div className="row">
                      ...
                      <div className="col-sm-6 mt-2 mb-4">
                        <h2 className="discription-headings pl-2 d-block">No. of Pages</h2>
