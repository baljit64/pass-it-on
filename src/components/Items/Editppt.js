...
class Editppt extends Component {
    ...
    axios.get('get-detail1/' + id).then(res => {
      if (res.data) {
        ...
        this.setState({
          ...
          no_of_slides: res.data.result[0].no_of_slides,
  ...
  update(e) {
    ...
    data.append("no_of_slides", this.state.no_of_slides)
    ...
    axios.post('/edit-Imagedetail1', data).then((res => {
      if (res.data) {
        ...
        if (res.data.message === "Your PPT data is sucessfully updated") {
          this.setState({
            success: true,
        ...
        <div>
          ...
          <div className="container">
            <div className="outer-box-discription">
              <h1 className="item-name">Edit Ppt</h1>
              {error}
              <div className="row">
                ...
                <div className="col-md-7 pt-md-5">
                  <form>
                    ...
                    <div className="row">
                      <div className="col-sm-6 mt-2 mb-4">
                        <h2 className="discription-headings pl-2 d-block">Slides</h2>
                        <input required className="sell-input d-block w-100"
                          value={this.state.no_of_slides}
                          onChange={(e) => this.setState({

                            no_of_slides: e.target.value
