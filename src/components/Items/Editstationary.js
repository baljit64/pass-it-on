...
class Editstationary extends Component {
  constructor() {
    super();
  ...
  apicall() {
    ...
    axios.get('get-detail1/' + id).then(res => {
      ...
      if (res.data) {
        // console.log(res.data.result[0].images.length)
        ...
        this.setState({
          imgcount: imgcount,
          reqimg: 5 - imgcount,
          item_name: res.data.result[0].item_name,
  ...
  update(e) {
    ...
    axios.post('/edit-Imagedetail1', data).then((res => {
      if (res.data) {
        ...
        if (res.data.message === "Your Stationary data is sucessfully updated") {
          this.setState({
            success: true,
        ...
        <div>
          ...
          <div className="container">
            <div className="outer-box-discription">
              <h1 className="item-name">Edit Stationary</h1>
              {error}
              <div className="row">
                ...
                <div className="col-md-5 ">
                  ...
                  {this.state.reqimg > 0 ?
                    <div className="Upload-img-btn-box text-center w-100 mx-auto pb-3 mr-3">

                      <label className="btn-lg mr-auto upload-img-label btn btn-upload w-75">+ Add Image {this.state.imgcount}/5
