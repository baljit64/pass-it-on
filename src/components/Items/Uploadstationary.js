...
class Uploadstationary extends Component {
  constructor() {
    super();
    ...
    this.state = {
      ...
      subcat: id.stationarySubcat,
      cat_id: id.cat.stationaryid,
      sub_cat_id: null,
      name: null,
      Quantity: null,
      Price: null,
  ...
  submitHandler = e => {
    ...
    if (this.valid()) {
      ...
      formData.append("item_name", this.state.name)
      ...
      axios.post('details', formData).then(res => {
        if (res.data.message === "Your Item is stored on Stationary section...") {
          this.setState({
            images: [],
            success: true,
            uploading: false
          ...
          <div className="col-lg-10 mx-auto">
            <div className="add-item-wrap">
              <form onSubmit={this.submitHandler}>
                <h1 className="item-name">Add Stationary Detail</h1>
                {error}
                <div className="row ">
                    ...
                    <div className="row">
                      ...
                      <div className="col-sm-6 mt-2 mb-4">
                        ...
                        <select required className="w-100 p-3" onChange={(e) => this.setState({
                          ...
                          <option value={this.state.subcat.ps}>Pen and Scale</option>
                          <option value={this.state.subcat.ac}>Arts and Crafts</option>
                          <option value={this.state.subcat.do}>Desk Organizer</option>
                          <option value={this.state.subcat.calc}>Calculator</option>
                          <option value={this.state.subcat.file}>File and Folders</option>
                          <option value={this.state.subcat.electronic}>Electronic</option>
                          <option value={this.state.subcat.decoration}>Hostel Room Decor</option>
